...
class PlaceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $places = $em->getRepository('LyonIsWildBundle:Place')->findAll();
    ...
    {
        $place = new Place();
        $form = $this->createForm('LyonIsWildBundle\Form\PlaceType', $place);
    ...
    {
        $deleteForm = $this->createDeleteForm($place);
        $editForm = $this->createForm('LyonIsWildBundle\Form\PlaceType', $place);
